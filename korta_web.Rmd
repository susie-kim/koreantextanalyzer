...
observeEvent(input$submit, {
  ...
  if (str_length(input$text) < 10) { # if there are less than 10 characters
    showNotification("Please write more.", type = "message")
  }
})
```
...
vocab_plot <- reactive({
  ...
  cowplot::plot_grid(plot, NULL, rel_widths = c(1, 1.2))
})
